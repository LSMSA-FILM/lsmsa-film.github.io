...
<DocCardList
  items={[
    {
      type: "link",
      href: "/docs/livestreaming/workflows/tricaster/",
    ...
    {
      type: "link",
      href: "/docs/livestreaming/workflows/obs/",
      label: "OBS Studio",
    ...
    {
      type: "link",
      href: "/docs/livestreaming/workflows/broadcaster-box/",
    ...
    {
      type: "link",
      href: "/docs/livestreaming/workflows/mobile-app/",
...
For more information about OBS Studio, see [OBS Reference](/docs/livestreaming/reference/obs/index.md).
